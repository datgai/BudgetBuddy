...
<div>
  <div class="mt-5 flex flex-col">
    ...
    <a href="/trade/lookup?symbol={symbol}"><button class="mt-5 w-full p-3 rounded-3xl shadowEffect bg-[--color-theme-2] bg-gradient-to-b from-indigo-800 from-100% via-indigo-900 from-20% to-violet-950 from-100% ">Lookup</button></a>
  </div>
</div>
