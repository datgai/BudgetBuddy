...
<body>
  <div>
    ...
    <div class="mb-8 flex flex-col gap-y-2">
      <div
        class="flex flex-col cardGradientBackground shadowEffect border-b-4 border-blue-700 rounded-[var(--card-border-radius)] px-6 py-2"
      >
        <h2 class="mb-8 text-2xl font-bold">Available Balance</h2>
        <h1 class="text-3xl font-bold">MYR 50,00.00</h1>
      ...
      <div class="flex flex-row gap-x-2">
        <div
          class="flex flex-1 flex-col cardGradientBackground shadowEffect border-b-4 border-blue-700 rounded-[var(--card-border-radius)] px-6 py-2"
        >
      ...
      >
        ...
        <h1 class="font-bold">MYR 1,000.00</h1>
      </div>
      ...
      >
        ...
        <h1 class="font-bold">MYR 180.00</h1>
      </div>
    </div>
